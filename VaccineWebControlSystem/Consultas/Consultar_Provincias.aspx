<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Consultar_Provincias.aspx.cs" Inherits="VaccineWebControlSystem.Consultas.Consultar_Provincias" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <div class="panel panel-success">
            <div class="panel-heading">Consulta de Provincias</div>
                <div class="panel-body">
                    ...
                    <div class="col-md-2">
                        <asp:DropDownList ID="FiltroDropDownList" runat="server" CssClass="auto-style4" AutoPostBack="True">
                            <asp:ListItem Value="ProvinciaId">Id</asp:ListItem>
                    ...
                    <div class="container col-md-11">
                        <asp:Button ID="ReporteButton" CssClass="btn btn-danger" runat="server" Text="Reporte" OnClick="ReporteButton_Click1" />
                    </div>
                </div>
            </div>
        </div>
