<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Consultar_Historiales.aspx.cs" Inherits="VaccineWebControlSystem.Consultas.WebForm1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <div class="panel panel-success">
            <div class="panel-heading">Consulta de Historiales</div>
            <div class="panel-body">
                <div class="form-horizontal col-md-12" role="form">
                    ...
                    <div class="container text-center col-md-10">
                        ...
                        <asp:TextBox ID="FechaInicialTextBox" runat="server" TextMode="Date" Width="20%"></asp:TextBox>
                        <asp:Label ID="Label3" runat="server" Text="Fecha Final"></asp:Label>
                        <asp:TextBox ID="FechaFinalTextBox" runat="server" TextMode="Date" Width="20%"></asp:TextBox>
                    </div>
