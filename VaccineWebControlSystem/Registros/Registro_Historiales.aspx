        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                ...
                <div class="form-group col-md-11">
                    ...
                    <asp:TextBox ID="CalendarTextBox" runat="server" CssClass="form-control" Type="date"></asp:TextBox>
                    <asp:Calendar ID="FechaCalendar" runat="server" Height="98px" Width="239px"></asp:Calendar>
                </div>
